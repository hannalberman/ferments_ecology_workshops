...
bar_plots <- ASV_df_prop %>%
  ...
  scale_fill_manual(values=c("gray40","#CC79A7", "#0072B2",  "#D55E00",  "#56B4E9", "#009E73",  "#E69F00", "darkslateblue", "#F0E442",  "darkgreen"), labels=levels(.$Species3)) +
...
substrate_beta_plot <- plot_grid(add_sub(plot_grid(ggplot+theme_void(), row12, nrow=1, rel_widths = c(0.05,1)), "NMDS2",  angle=90, x=0.05, y=3.9))
```
