...
save_kable(minLibSizeTable, file.path(figure_out, "minLibSizeTable.png"), zoom=5)
```
...
plot_grid(libSizePlot, bottom_row, ncol = 1, rel_widths = 1, rel_heights = c(1,0.2), labels = c("A", "B"), label_size = 15)
